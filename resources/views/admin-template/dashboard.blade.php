...
@section('content')
    <div class="row text-center mt-4">
        <h2>
            Merhaba Selin, Hoşgeldin!
        </h2>

        <h4 class="mt-3">
            Admin template senin de bir çok içeriği güncelleyebilmen için hazırlandı.
            <br>
            <br>
        ...
        <br>
        <h4>
            Kullanmadan önce lütfen aşağıdaki notu dikkatlice oku!
        </h4>
        ...
        <h5>
            Fotoğraf güncelleme alanları sayfanın diğer içeriklerinde bağımsız çalışır.
            <br>
            <br>
            Nasıl Yani;
            <br>
            Ülkeler için bir güncelleme yapıyorsun ve metinde bir değişiklik yaptın. Onu kaydetmeden önce farklı
            fotoğraflarda ekledin fotoğraflar eklendiği için sayfadan çıktığında metin güncellenmez.
            <br>
            Dolayısıyla fotoğraf alanlarının, metin veya diğer içeriklerden bağımsız olduğunu unutma!
        </h5>

        <h5>
            <a target="_blank" href="https://mannatthemes.com/approx/default/index.html">Templati buradan
                incelebilirsin.
            </a>
            ...
            <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                ...
                <div class="">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#">WCT Panel</a>
                        </li><!--end nav-item-->
                    ...
                    <div class="card  bg-welcome-img overflow-hidden">
                        <div class="card-body">
                            <div class="">
                                ...
                                <img src="{{ asset('admin-template/assets/images/extra/fund.png') }}" alt=""
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form class="">
                                        <select id="dynamic-select" name="example-select"
                                            ...
                                            <option value="1"
                                                data-img="{{ asset('admin-template/assets/images/logos/m-card.png') }}">
                                                xx25</option>
                                            <option value="2"
                                                data-img="{{ asset('admin-template/assets/images/logos/ame-bank.png') }}">
                                                xx56</option>
                                        </select>
                                    </form>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class=" text-center mx-auto">
                        <img src="{{ asset('admin-template/assets/images/extra/rabit.png') }}" alt=""
                            class="d-inline-block" height="105">
                    </div>
                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/flags/us_flag.jpg') }}"
                                    ...
                                    <td class="px-0 text-end"><span
                                            ...
                                            <span class="badge rounded text-success bg-success-subtle">1.10%</span></span>
                                    </td>
                                </tr><!--end tr-->
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/flags/spain_flag.jpg') }}"
                                                class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <td class="px-0 text-end"><span
                                            ...
                                            <span class="badge rounded text-success bg-success-subtle">0.91%</span></span>
                                    </td>
                                </tr><!--end tr-->
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/flags/french_flag.jpg') }}"
                                                class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/flags/germany_flag.jpg') }}"
                                                class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <td class="px-0 text-end"><span
                                            ...
                                            <span class="badge rounded text-success bg-success-subtle">0.85%</span></span>
                                    </td>
                                </tr><!--end tr-->
                                <tr class="">
                                    <td class="px-0">
                                ...
                                <tr class="">
                                    <td class="px-0 pb-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/flags/baha_flag.jpg') }}"
                                                class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/logos/lang-logo/chatgpt') }}.png"
                                                height="40" class="me-3 align-self-center rounded" alt="...">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/logos/lang-logo/gitlab') }}.png"
                                                height="40" class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/logos/lang-logo/nextjs') }}.png"
                                                height="40" class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/logos/lang-logo/vue') }}.png"
                                                height="40" class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                                <h6 class="m-0">Vue</h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/logos/lang-logo/symfony') }}.png"
                                                height="40" class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/users/avatar-1.jpg') }}"
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/users/avatar-2.jpg') }}"
                                                height="36" class="me-2 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr>
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/users/avatar-5.jpg') }}"
                                                height="36" class="me-2 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin-template/assets/images/users/avatar-9.jpg') }}"
                                                height="36" class="me-2 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                                <h6 class="m-0 text-truncate">Steven Sharp </h6>
                                                <a href="#"
...
@section('page-scripts')
    ...
    <script src="{{ asset('admin-template/assets/apexcharts/samples/assets/stock-prices.js') }}"></script>
    <script src="{{ asset('admin-template/assets/js/pages/index.init.js') }}"></script>
    <script src="{{ asset('admin-template/assets/js/DynamicSelect.js') }}"></script>
@endsection
