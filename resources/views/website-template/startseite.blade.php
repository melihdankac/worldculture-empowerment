        ...
        <div id="slider1" class="rev_slider" data-version="5.0">
            <ul>
                <li data-transition="fade">
                    <img src="{{ asset('website-template/images/slider/1.jpg') }}" alt="" width="1920" height="882"
                        data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1">

                    <div class="tp-caption  tp-resizeme" data-x="left" data-hoffset="15" data-y="top" data-voffset="300"
                ...
                <li data-transition="fade">
                    <img src="{{ asset('website-template/images/slider/2.jpg') }}" alt="" width="1920"
                        height="882" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat"
                        data-bgparallax="1">
                ...
                <li data-transition="fade">
                    <img src="{{ asset('website-template/images/slider/3.jpg') }}" alt="" width="1920"
                        height="882" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat"
                        data-bgparallax="1">
                        ...
                        <div class="item">
                            ...
                            <div class="clearfix bg-area">
                                <figure class="img-box">
                                    <img src="{{ asset('website-template/images/feature/f.jpg') }}" alt="">
                                </figure>


                                <div class="content">
                                    <h4>Helping for <span>education</span> to syrian <br>child & <span>food
                                            planting</span></h4>
                                    ...
                                    <div class="donate-price"><b>$44,210</b>&nbsp; Raised of <span>$99,541</span>
                                        Goal</div>
                                    <div class="link"><a href="single-cause.html" class="thm-btn style-2">donate
                                            now</a></div>
                                </div>
                            </div>
                ...
                <div class="item">
                    <div class="bg-area">
                        ...
                        <div class="content-box">
                            ...
                            <p>Lorum ipsum iure reprhe pu nderit sit amet,consectetur neque. Lorum ipsum iure
                                reprhepu nderitsit amet,onsectetur neque.</p>
                            <div class="link"><a href="single-cause.html" class="thm-btn style-2">donate
                                    now</a></div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            ...
                            <div class="content-box">
                                <ul class="default-list">
                                    <li><i class="flaticon-check-mark-square-button"></i><span>60% </span>money
                                        goes for <span>Food Donation</span> in <span>Syria</span></li>
                                    <li><i class="flaticon-check-mark-square-button"></i><span>35%</span> money
                                        goes for <span>Educational Fund </span>in <span>Bihar</span></li>
                                    <li><i class="flaticon-check-mark-square-button"></i><span>15%</span> money
                                        goes for <span>Health Donation </span>in <span>Bangladesh</span></li>
                                    <li><i class="flaticon-check-mark-square-button"></i><span>20% </span>money
                                        goes for <span>Building house </span>for shelter</li>
                                </ul>
    ...
    <section class="parallax-sec-one">
        <div class="container">
            ...
            <div class="content-box text-center">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididun labore
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="item">
                            ...
                            <h3>Giving Food</h3>
                            <div class="link"><a href="#" class="thm-btn style-3">read more<i
