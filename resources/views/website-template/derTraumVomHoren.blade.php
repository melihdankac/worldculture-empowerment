...
@section('content')
        ...
        <div id="slider1" class="rev_slider" data-version="5.0">
            <ul>
                <li data-transition="fade">
                    ...
                    <div class="tp-caption  tp-resizeme" data-x="left" data-hoffset="15" data-y="top" data-voffset="500"
                        ...
                        <div class="slide-content-box center">
                            ...
                            <h1>Eine Chance auf ein neues Leben</h1>
                            <h4>Worldculture Travels</h4>
                        </div>
                    </div>
                    <div class="tp-caption tp-resizeme" data-x="center" data-hoffset="0" data-y="center" data-voffset="300"
                        data-transform_idle="o:1;"
                        ...
                        <div class="slide-content-box">
                            <div class="button">
                                <a class="thm-btn" href="{{ route('kontakt') }}">Kontaktiere uns</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="hero-banner">
        <img src="{{ asset('website-template/images/projects/dream-of-hearing/bg_image.webp') }}"
            alt="Velids Traum vom Hören">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section-title">
                        <h3>Velids Traum vom Hören <br>
                            <span>Eine Chance auf ein neues Leben</span>
                        </h3>
                        <br>
                        ...
                        &nbsp;
                        <p>Um Velid ein selbstbestimmtes Leben zu ermöglichen, sind wir auf Unterstützung angewiesen.
                            ...
                            Velid
                            die Zukunft zu schenken, die er verdient. </p>&nbsp;
                        <p>Januar 2025</p>
                    </div>
                </div>
            </div>
    ...
    <section id="media-gallery" style="padding:40px 0;">
        <div class="container">
            ...
            <div class="media-grid"
                ...
                <!-- VİDEOLAR -->
                {{-- <a data-fancybox href="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}">Videoyu
                    izle</a>
                ...
                <figure class="media-item video-item"
                    ...
                    border-radius: 8px;
                    cursor: pointer;">
                    <video width="100%" height="400" style="object-fit: cover"
                        poster="{{ asset('website-template/images/projects/dream-of-hearing/2.webp') }}">
                        <source src="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}"
                            type="video/mp4" />
                        <img src="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}"
                            alt=""
                            data-video="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}"
                            style="
                        width: 100%;
                        height: 180px;
                        object-fit: cover;
                        display: block;" />
                        <figcaption style="text-align: center; margin-top: 4px"></figcaption>
                    </video>
                </figure>

                <figure class="media-item video-item" style="margin:0; overflow:hidden; border-radius:8px; cursor:pointer;">
                    <video width="100%" height="400" style="object-fit:cover;"
                        poster="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}">
                        <source src="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}"
                            type="video/mp4">
                        <img src="{{ asset('website-template/images/projects/dream-of-hearing/video1.mp4') }}"
                            alt=""
    ...
    <div id="photo-lightbox"
     ...
     background:rgba(0,0,0,0.8); z-index:9999; padding:20px;">
        <div style="max-width:1100px; width:100%; max-height:90vh; position:relative;">
            <button id="plb-close"
                style="position:absolute; right:8px; top:45px; background:transparent; border:none; color:#fff; font-size:45px; cursor:pointer;">&times;</button>
            <button id="plb-prev"
                style="position:absolute; left:8px; top:50%; transform:translateY(-50%); background:rgba(0,0,0,0.5); border:none; color:#fff; font-size:32px; cursor:pointer; padding:8px 12px; border-radius:4px;">&lt;</button>
            <button id="plb-next"
                style="position:absolute; right:8px; top:50%; transform:translateY(-50%); background:rgba(0,0,0,0.5); border:none; color:#fff; font-size:32px; cursor:pointer; padding:8px 12px; border-radius:4px;">&gt;</button>
            <img id="plb-img" src="" alt=""
                style="width:100%; height:auto; display:block; border-radius:6px; max-height:85vh; object-fit:contain;">
            <p id="plb-caption" style="color:#ddd; margin-top:8px; text-align:center;"></p>
        </div>
    </div>
    <!-- !SECTION - Photo Lightbox -->
    ...
    <div id="video-lightbox"
     ...
     background:rgba(0,0,0,0.8); z-index:9999; padding:20px;">
        <div style="max-width:900px; width:100%; position:relative;">
            <button id="vlb-close"
                style="position:absolute; right:8px; top:20px; background:transparent; border:none; color:#fff; font-size:28px; cursor:pointer;">&times;</button>
            <iframe id="vlb-video" src="" style="width:100%; height:500px; border:none; border-radius:6px;"
